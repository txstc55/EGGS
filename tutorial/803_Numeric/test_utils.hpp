...
#define PROFILE_MKL_CONST_OP2_SINGLE(MATRIX_VECTOR, R, result_file)                                                                                                                                                         \
    do                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                       \
        sparse_status_t status;                                                                                                                                                                                             \
        std::vector<sparse_matrix_t> matrix_vectors, result_vectors;                                                                                                                                                        \
        ...
        auto elapsed_add = benchmarkTimer([&]() {                                                                                                                                                                           \
            for (int j = 0; j < 25; j++)                                                                                                                                                                                    \
            {                                                                                                                                                                                                               \
                status = mkl_sparse_d_add(SPARSE_OPERATION_NON_TRANSPOSE, matrix_vectors[0], 1.0, matrix_vectors[1], &result_vectors[0]);                                                                                   \
                status = mkl_sparse_d_add(SPARSE_OPERATION_NON_TRANSPOSE, result_vectors[0], 1.0, matrix_vectors[2], &result_vectors[1]);                                                                                   \
            }                                                                                                                                                                                                               \
        });                                                                                                                                                                                                                 \
        status = mkl_sparse_sp2m(SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[0], SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[1], SPARSE_STAGE_NNZ_COUNT, &result_vectors[2]);             \
        status = mkl_sparse_sp2m(SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[0], SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[1], SPARSE_STAGE_FINALIZE_MULT_NO_VAL, &result_vectors[2]);  \
        auto elapsed_mult = benchmarkTimer([&]() {                                                                                                                                                                          \
            for (int j = 0; j < 25; j++)                                                                                                                                                                                    \
            {                                                                                                                                                                                                               \
                status = mkl_sparse_sp2m(SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[0], SPARSE_OPERATION_NON_TRANSPOSE, general_type, result_vectors[1], SPARSE_STAGE_FINALIZE_MULT, &result_vectors[2]); \
            }                                                                                                                                                                                                               \
        });                                                                                                                                                                                                                 \
        std::cout << "MKL CONST TEST 2 SINGLE: " << elapsed_add + elapsed_mult << " us\n";                                                                                                                                  \
        result_file << "MKL CONST TEST 2 SINGLE: " << elapsed_add + elapsed_mult << " us\n";                                                                                                                                \
        R = result_vectors[2];                                                                                                                                                                                              \
        mkl_free_buffers();                                                                                                                                                                                                 \
    } while (0)

#define PROFILE_MKL_CONST_OP2_MULT(MATRIX_VECTOR, R, result_file)                                                                                                                                                           \
    do                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                       \
        sparse_status_t status;                                                                                                                                                                                             \
        std::vector<sparse_matrix_t> matrix_vectors, result_vectors;                                                                                                                                                        \
        ...
        std::cout << "MKL CONST TEST 2 MULT: " << elapsed_add + elapsed_mult << " us\n";                                                                                                                                    \
        result_file << "MKL CONST TEST 2 MULT: " << elapsed_add + elapsed_mult << " us\n";                                                                                                                                  \
        R = result_vectors[2];                                                                                                                                                                                              \
        mkl_free_buffers();                                                                                                                                                                                                 \
    } while (0)
